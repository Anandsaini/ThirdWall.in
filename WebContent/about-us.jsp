                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="challange_text_inner">
                            ...
                            <p>3rd Wall is creative and dynamic mechanical Design team that takes a client concept and develops a Computer added design using various design handy tools, like Autocad, solid works, CATIA V5 Etc. and then also offers them to 3D printing service or a compeletly functionlly prototype of the designed product, Our multi disciplined teams and our collaborative design processes have resulted in outstanding products for clients in Automotive, Consumer electronics, Furniture, Housewares, IoT, Industrial Automation, Life Style & Exhibition, Medical & Healthcare, Mobile/Smart devices, Packaging, Retail, Security & Surveillance, Telecommunication and Wearable technology. </p>
                            <div class="c_video">
                ...
                <div class="testimonials_slider owl-carousel">
                    <div class="item">
                        <div class="testi_item">
                            <h3>Amit Kumar</h3>
                            <p>Post completion of B.Tech in Mechanical Engineering worked as a Senior Design Engineer to INDIUM 3D Printers leading the Development of 3D Technology. Worked at numerous situational analytics and strategy projects with expertise in product management and innovation</p>
                            <div class="media">
                                <div class="d-flex">
                    ...
                    <div class="item">
                        <div class="testi_item">
                            <h3> Anand Saini </h3>
                            <p>Saraca offers a wide range of mechanical engineering solutions such as Concept Design and Development, Idea Generation, CAD Automation, Technical Documentation, Process Planning and Automation.</p>
                            <div class="media">
                                <div class="d-flex">
                                    <img class="rounded-circle" src="img/testimonials/testi-1.jpg" alt="">
                                </div>
                ...
                <div class="row company_inner">
                    ...
                    <div class="col-lg-6">
                        <div class="company_skill">
                            <p>3rd Wall offers a wide range of mechanical engineering solutions such as Concept Design and Development, Idea Generation, CAD Automation, Technical Documentation, Process Planning and Automation.</p>
